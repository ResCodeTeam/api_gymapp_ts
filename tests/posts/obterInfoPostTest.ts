...
const token = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE2NTAwMzc3MzAsImV4cCI6MTY1MDAzODYzMCwic3ViIjoiMDAwZDFlMTQtNjE3ZS00MjNlLThhMWEtZjYzZDRmYTVhZjZhIn0.7Z2uXYR8ovvxOUHDtnbLQ2rsJYWRkNmYC3XiiPreh5U'
const idPost = '07199b7e-578a-46fe-8fbf-b5ca2b5bf5c8'
describe('Obter info post sem token', () => {
  it('Deve retornar erro de token invalido', () => {
    return chai.request(server).get(baseUrl+'/posts/post/'+idPost)
      .then(res => {
...
describe('Obter info post route com token invalido', () => {
  it('Deve retornar erro de token invalido', () => {
    return chai
    .request(server)
...
describe('Obter info post route teste unitário', () => {
