import { checkModalidadeExists, checkUserIdExists, getAlunoMarca, getTreinadorMarca } from "../../helpers/dbHelpers";
...
export class CriarPlanoTreinoService{
  async execute({ alunoId, treinadorId, data, modalidadeId, blocos}: IPlano) {
    ...
    if(marcaId == aluno)
    {
      ...
      throw new Error ("O aluno não pertence à mesma marca")
    }
  }
}
