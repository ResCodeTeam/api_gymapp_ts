    ...
    it('Deve retornar um desafio', () => {
      ...
      .then(res => {
        ...
        if(res.body['regras_desafio'].length>0){
            ...
            chai.expect(res.body['regras_desafio']).to.have.property("descricao")

            chai.expect(res.body['regras_desafio']['descricao']).to.be.a("string")
        }
        ...
        if(res.body['exercicios_desafio'].length>0){
            ...
            chai.expect(res.body['exercicios_desafio']).to.have.property("n_ordem_exercicio")
            chai.expect(res.body['exercicios_desafio']).to.have.property("genero")
            chai.expect(res.body['exercicios_desafio']).to.have.property("exercicios")
            chai.expect(res.body['exercicios_desafio']).to.have.property("series_desafio")


            chai.expect(res.body['exercicios_desafio']['n_ordem_exercicio']).to.be.an("int")
            chai.expect(res.body['exercicios_desafio']['genero']).to.be.an("int")
            chai.expect(res.body['exercicios_desafio']['exercicios']).to.be.an("array")
            chai.expect(res.body['exercicios_desafio']['series_desafio']).to.be.an("array")
        }
        ...
        if(res.body['exercicios_desafio']['exercicios'].length>0){
            ...
            chai.expect(res.body['exercicios_desafio']['exercicios']).to.be.an("object")

            chai.expect(res.body['exercicios_desafio']['exercicios']).to.have.property("nome")
            chai.expect(res.body['exercicios_desafio']['exercicios']).to.have.property("descricao")
            chai.expect(res.body['exercicios_desafio']['exercicios']).to.have.property("is_tempo")
            chai.expect(res.body['exercicios_desafio']['exercicios']).to.have.property("imagens")
            chai.expect(res.body['exercicios_desafio']['exercicios']).to.have.property("musculos")
        ...
        //verificar se array das propriedades estão corretos
        if(res.body['exercicios_desafio']['exercicios']['imagens'].length>0){

            chai.expect(res.body['exercicios_desafio']['exercicios']['imagens']).to.be.an("object")

            chai.expect(res.body['exercicios_desafio']['exercicios']['imagens']).to.have.property("url")
 
            chai.expect(res.body['exercicios_desafio']['exercicios']['imagens']['url']).to.be.a("string")
        }

        //verificar se array das propriedades estão corretos
        if(res.body['exercicios_desafio']['exercicios']['musculos'].length>0){

            chai.expect(res.body['exercicios_desafio']['exercicios']['musculos']).to.be.an("object")

            chai.expect(res.body['exercicios_desafio']['exercicios']['musculos']).to.have.property("musculos")

            chai.expect(res.body['exercicios_desafio']['exercicios']['musculos']['musculos']).to.be.an("array")
        }

        //verificar se array das propriedades estão corretos
        if(res.body['exercicios_desafio']['exercicios']['musculos']['musculos'].length>0){

            chai.expect(res.body['exercicios_desafio']['exercicios']['musculos']['musculos']).to.be.an("object")

            chai.expect(res.body['exercicios_desafio']['exercicios']['musculos']['musculos']).to.have.property("nome")
            chai.expect(res.body['exercicios_desafio']['exercicios']['musculos']['musculos']).to.have.property("imagem_url")

            chai.expect(res.body['exercicios_desafio']['exercicios']['musculos']['musculos']['nome']).to.be.a("string")
            chai.expect(res.body['exercicios_desafio']['exercicios']['musculos']['musculos']['imagem_url']).to.be.a("string")
        }
