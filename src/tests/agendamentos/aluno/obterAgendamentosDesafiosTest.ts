...
describe("Teste obter agendamentos de desafios do aluno", () => {
    beforeEach((done) => {
        chai
            .request(server)
    ...
    describe('- Sem token', () => {
        it('Deve retornar erro de authToken invalido', () => {
            return chai.request(server).get(baseUrl + '/aluno/agenda/desafios/')
                .then(res => {
    ...
    describe('- Token invalido', () => {
        it('Deve retornar erro de authToken invalido', () => {
            return chai
                .request(server)
                .get(baseUrl + '/aluno/agenda/desafios/')
    ...
    describe('- Obter agendamentos de desafios do aluno corretamente', () => {
        it('Deve Obter agendamentos de desafios do aluno corretamente', () => {
            return chai
                .request(server)
                .get(baseUrl + '/aluno/agenda/desafios/')
